...
def main():
    ...
    if args.model_dir is not None:
        ...
        env_config_file = shutil.copy(args.env_config, args.model_dir)
        policy_config_file = shutil.copy(args.policy_config, args.model_dir)
        ...
        if args.il:
            ...
            model_weights = shutil.copy('il_model.pth', args.model_dir)
        else:
            if os.path.exists(os.path.join(args.model_dir, 'resumed_rl_model.pth')):
                print("model: resumed_rl_model.pth")
                # model_weights = os.path.join(args.model_dir, 'resumed_rl_model.pth')
                model_weights = shutil.copy('resumed_rl_model.pth', args.model_dir)
            else:
                model_path_ = "data2/actenvcarl_alltf/rl_model_5400.pth"
                print("model: ", model_path_)
                # model_weights = os.path.join(args.model_dir, model_path_)
                model_weights = shutil.copy(model_path_, args.model_dir)
    else:
