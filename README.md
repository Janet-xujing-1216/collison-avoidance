...
```
2. Test policies with 500 test cases.(在实际代码中是50 cases 修改了一下test的代码)
```
...
```
python test.py --policy actenvcarl --test_policy_flag 5 --multi_process self_attention --agent_timestep 0.4 --human_timestep 0.5 --reward_increment 2.0 --position_variance 2.0  --direction_variance 2.0 --model_dir data/output --phase test --visualize --test_case 0 --video_file data/output
```
